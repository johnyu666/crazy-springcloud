package com.crazymaker.springcloud.back.generate.utils;

import cn.hutool.core.date.DateUtil;
import com.crazymaker.springcloud.back.generate.model.ColumnEntity;
import com.crazymaker.springcloud.back.generate.model.TableEntity;
                                     ...
                                     String basePath)
    {
        ...
        for (String template : templates)
        {
            ...
            )
            {
                ...
                FileUtil.generateFile(filePath, sw.toString());
            } catch (IOException e)
            {
                log.error("generatorCode-error", e);
            }
