...
public class RedisClientDetailsService extends JdbcClientDetailsService
{
    ...
    public ClientDetails loadClientByClientId(String clientId)
    {
        ...
        ClientDetails clientDetails =
                (ClientDetails) RedisRepository.singleton().getObject(clientRedisKey(clientId));
    ...
    private ClientDetails cacheAndGetClient(String clientId)
    {
        ...
        try
        {
            ...
            {
                // 写入redis缓存
                RedisRepository.singleton().setObject(clientRedisKey(clientId), clientDetails);
    ...
    {
        RedisRepository.singleton().del(clientRedisKey(clientId));
    }
    ...
    public void loadAllClientToCache()
    {
        ...
        list.parallelStream().forEach(client -> RedisRepository.singleton().setObject(clientRedisKey(client.getClientId()), client));
    }
