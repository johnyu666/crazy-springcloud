...
public class JwtAuthenticationFilter extends OncePerRequestFilter
{
    ...
    private RequestMatcher backRequiresAuthenticationRequestMatcher;
    ...
    public JwtAuthenticationFilter()
    {
        ...
        this.backRequiresAuthenticationRequestMatcher = new RequestHeaderRequestMatcher(SessionConstants.ADMIN_AUTHORIZATION_HEAD);
    }
            ...
            throws ServletException, IOException
    {
        ...
        //管理控制台存放的 JWT 的HTTP头部字段为 Authorization
                                             ...
                                             HttpServletResponse response)
    {
        ...
        return backRequiresAuthenticationRequestMatcher.matches(request);
