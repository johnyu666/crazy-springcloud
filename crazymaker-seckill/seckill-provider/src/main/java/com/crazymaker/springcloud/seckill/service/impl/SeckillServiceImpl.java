...
public class SeckillServiceImpl
{
            ...
            long goodId, BigDecimal money, long userId, String md5)
    {
         ...
         */
        Boolean isLimited = zkRateLimitServiceImpl.tryAcquire(String.valueOf(goodId));
        if (isLimited)
        {     //秒杀异常
        ...
        InterProcessMutex lock =
                zkLockServiceImpl.getZookeeperLock(String.valueOf(goodId));
    ...
    public void doSeckillV3(SeckillOrderPO order)
    {
        ...
        List<String> redisKeys = new ArrayList<>();
        redisKeys.add(String.valueOf(order.getGoodId()));
